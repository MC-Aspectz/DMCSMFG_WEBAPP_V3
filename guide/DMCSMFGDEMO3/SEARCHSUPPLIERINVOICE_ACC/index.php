...
<head>
    ...
    <title><?=$_SESSION['APPNAME'].' - '.$data['DRPLANG']['APPCODE']['SEARCHSUPPLIERINVOICE_ACC']; ?></title>
</head>
<body>
<main>
                    ...
                    if (!empty($tdata)) { $minrow = count($tdata);
                        foreach ($tdata as $item) {  ?>
                            <tr class="flex w-full p-0 divide-x">
                                ...
                                <td class="h-6 w-2/12 pl-1 text-sm"><?=$item['INVOICENO'] ?></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <table class="w-full border-collapse border border-slate-500" id="tabel_modal" rules="cols" cellpadding="3" cellspacing="1" >
                    ...
                    <tbody>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$data['TXTLANG']["INVOICENO"] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="INVOICENO"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=$data['TXTLANG']["PV_NO"] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="PV_NO" style="background-color:#ffe6cc;"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$data['TXTLANG']["DATE"] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="DATE"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=$data['TXTLANG']["PO_NO"] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="PO_NO" style="background-color:#ffe6cc;"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$data['TXTLANG']["SUPPLIERCODE"] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="SUPPLIERCODE"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=$data['TXTLANG']["SUPPLIERNAME"] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="SUPPLIERNAME" style="background-color:#ffe6cc;"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$data['TXTLANG']["STATUS"] ?></td>
