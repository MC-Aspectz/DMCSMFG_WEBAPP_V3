...
// ------------------------- CALL Langauge -------------------//
$loadApp = getSystemData('SEARCHSALETRAN_ACC2');
if(empty($loadApp)) {
    $loadApp = $syslogic->getLoadApp('SEARCHSALETRAN_ACC2');
    $syslogic->ProgramRundelete('SEARCHSALETRAN_ACC2');
    setSystemData('SEARCHSALETRAN_ACC2', $loadApp);
}
//  else {
//     $setLoadApp = $syslogic->setLoadApp('SEARCHSALETRAN_ACC2');
// }
