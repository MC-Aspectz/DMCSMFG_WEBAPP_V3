...
<head>
    ...
    <title><?=$_SESSION['APPNAME'].' - '.$data['DRPLANG']['APPCODE']['SEARCHPURRECTRANFORDC2_ACC']; ?></title>
</head>
<body>
<main>
    ...
    <form class="w-full h-screen p-2" method="POST" id="saletrans" name="saletrans" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
        ...
        <div class="table">
            <table id="table_result" class="w-full border-collapse border border-slate-500">
                ...
                <tbody class="flex flex-col overflow-y-scroll w-full h-[252px]"><?php
                ...
                foreach ($tdata as $item) {  ?>
                    <tr class="flex w-full p-0 divide-x">
                        ...
                        <td class="h-6 w-2/12 pl-1 text-sm"><?=$item['PURRECINSPDT'] ?></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="w-full border-collapse border border-slate-500" id="tabel_modal" rules="cols" cellpadding="3" cellspacing="1" >
                        ...
                        <tbody>
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm"><?=checklang('PV_NO'); ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="PV_NO"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm"><?=checklang('PO_NO'); ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="PO_NO"></td>
                            </tr>
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=checklang('SUPPLIERCODE'); ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="SUPPLIERCODE" style="background-color:#ffe6cc;"></td>
                            </tr>
                            <tr>
