...
<head>
    ...
    <title><?=$_SESSION['APPNAME'].' - '.$lang['customerindex']; ?></title>
</head>
<body>
<main>
    ...
    <form class="w-full h-screen p-2" method="POST" id="guideindex" name="guideindex" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
        <div class="flex mb-1">
            <div class="flex w-7/12">
                ...
                <input type="text" class="text-control shadow-md border rounded-xl h-7 w-4/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        id="P1_CUSTCD" name="P1_CUSTCD" value="<?=$P1_CUSTCD ?>"/>&ensp;-&ensp;
                <input type="text" class="text-control shadow-md border rounded-xl h-7 w-4/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        id="P2_CUSTCD" name="P2_CUSTCD" value="<?=$P2_CUSTCD ?>"/>
            </div>
        ...
        <div class="flex mb-1">
            <div class="flex w-7/12">
                <label class="text-color block text-sm w-3/12 pr-2 pt-1"><?=$lang['customername']; ?></label>
                <input type="text" class="text-control shadow-md border rounded-xl h-7 w-4/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        id="P3_CUSTNM" name="P3_CUSTNM" value="<?=$P3_CUSTNM ?>"/>
            </div>
            <div class="flex w-5/12"></div>
        </div>
        ...
        <div class="flex mb-1">
            <div class="flex w-7/12">
                ...
                <input type="text" class="text-control shadow-md border rounded-xl h-7 w-4/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        id="P4_SEARCHCHAR" name="P4_SEARCHCHAR" value="<?=$P4_SEARCHCHAR ?>"/>
            </div>
            <div class="flex w-5/12"></div>
        </div>
        ...
        <div class="flex mb-1">
            <div class="flex w-7/12">
                <label class="text-color block text-sm w-3/12 pr-2 pt-1"><?=$lang['address']; ?></label>
                <input type="text" class="text-control shadow-md border rounded-xl h-7 w-4/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        id="P5_CUSTADDR" name="P5_CUSTADDR" value="<?=$P5_CUSTADDR ?>"/>
            </div>
            <div class="flex w-5/12"></div>
        </div>
        ...
        <div class="flex mb-1">
            <div class="flex w-7/12">
                ...
                <input type="text" class="text-control shadow-md border rounded-xl h-7 w-4/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        id="P6_CUSTADDR" name="P6_CUSTADDR" value="<?=$P6_CUSTADDR ?>"/>
            </div>
            ...
            <table id="table_result" class="quote_table w-full border-collapse border border-slate-500">
                <thead class="sticky top-0 z-20 bg-gray-50">
                    <tr class="border border-gray-600">
                        ...
                        <th class="px-6 text-center border border-slate-700 text-center">
                            <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=$lang['postalcode']; ?></span>
                        </th>
                        <th class="px-6 text-center border border-slate-700 text-center">
                        ...
                        <th class="px-6 text-center border border-slate-700 text-center">
                            <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=$lang['tel']; ?></span>
                        </th>
                    </tr>
                </thead>
                    ...
                    if (!empty($tdata)) { $minrow = count($tdata);
                        foreach($tdata as $key => $item) { ?>
                            <tr class="row-id">
                                ...
                                <td class="h-6 pl-1 text-sm border border-slate-700 text-left whitespace-nowrap"><?=$item['CUSTOMERZIPCODE'] ?></td>
                                <td class="h-6 pl-1 text-sm border border-slate-700 text-left whitespace-nowrap"><?=$item['CUSTOMERADDR1'] ?></td>
                                <td class="h-6 pl-1 text-sm border border-slate-700 text-left whitespace-nowrap"><?=$item['CUSTOMERADDR2'] ?></td>
                                <td class="h-6 pl-1 text-sm border border-slate-700 text-left whitespace-nowrap"><?=$item['CUSTOMERTEL'] ?></td>
                            </tr><?php 
                        }
                    } 
            ...
            <div class="modal-body">
                <table class="w-full border-collapse border border-slate-500" id="tb-modal" rules="cols" cellpadding="3" cellspacing="1" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$lang['postalcode'] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="postalcode"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$lang['tel'] ?></td>
