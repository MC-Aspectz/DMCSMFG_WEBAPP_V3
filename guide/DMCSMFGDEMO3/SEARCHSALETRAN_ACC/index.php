        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               <table class="w-full border-collapse border border-slate-500" id="tabel_modal" rules="cols" cellpadding="3" cellspacing="1" >
                    ...
                    <tbody>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=checklang('INVOICE_NO'); ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="INVOICE_NO"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=checklang('SALEORDERNO'); ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="SALEORDERNO" style="background-color:#ffe6cc;"></td>
                        </tr>
                        <tr>
