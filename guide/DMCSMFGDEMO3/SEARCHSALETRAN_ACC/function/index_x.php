...
// ------------------------- CALL Langauge -------------------//
$loadApp = getSystemData('SEARCHSALETRAN_ACC');
if(empty($loadApp)) {
    $loadApp = $syslogic->getLoadApp('SEARCHSALETRAN_ACC');
    $syslogic->ProgramRundelete('SEARCHSALETRAN_ACC');
    setSystemData('SEARCHSALETRAN_ACC', $loadApp);
}
//  else {
//     $setLoadApp = $syslogic->setLoadApp('SEARCHSALETRAN_ACC');
// }
