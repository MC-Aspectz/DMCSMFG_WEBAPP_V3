...
<head>
    ...
    <title><?=$_SESSION['APPNAME'].' - '.$lang['directindex']; ?></title>
</head>
<body>
<main>
    ...
    <form class="w-full h-screen p-2" method="POST" id="directindex" name="directindex" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">

    <div class="flex mb-1">
        <div class="flex w-6/12">
            <label class="text-color block text-sm w-3/12 pr-2 pt-1"><?=$lang['districtcode']; ?></label>
            ...
            <table id="table_result" class="w-full border-collapse border border-slate-500">
                <thead class="w-full bg-gray-100">
                    <tr class="flex w-full divide-x csv-row">
                        <th class="w-6/12 text-center csv-col">
                            <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=$lang['districtcode']; ?></span>
                        </th>
                        <th class="w-6/12 text-center csv-col">
                            <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=$lang['districtname']; ?></span>
                        </th>
                    </tr>
                </thead>
                ...
                foreach ($tdata as $item) {  ?>
                    <tr class="flex w-full p-0 divide-x csv-row">
                        ...
                        <td class="h-6 w-6/12 pl-1 text-sm csv-col"><?=$item["DIRECTCD"] ?></td>
                        <td class="h-6 w-6/12 pl-1 text-sm csv-col"><?=$item["DIRECTNAME"] ?></td>
                    </tr>
                <?php }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="w-full border-collapse border border-slate-500" id="tabel_modal" rules="cols" cellpadding="3" cellspacing="1" >
                    ...
                    <tbody>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$lang['districtcode'] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="districtcode"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=$lang['districtname'] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="districtname" style="background-color:#ffe6cc;"></td>
                        </tr>
                    </tbody>
                </table>
                <br>
