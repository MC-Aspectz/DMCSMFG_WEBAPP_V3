...
if(isset($_POST['search'])) {
    ...
    $tdata = $javaFunc->searchLoc($P1, $P2);
}

if(!empty($_GET)) {
    $P1 = isset($_GET['LOCTYP']) ? $_GET['LOCTYP']:'';
}

$typeItem = getDropdownData('STORAGETYPE');
if(empty($typeItem)) {
    $typeItem = $syslogic->getPullDownData('STORAGETYPE', $_SESSION['LANG']);
    setDropdownData('STORAGETYPE', $typeItem);
}
