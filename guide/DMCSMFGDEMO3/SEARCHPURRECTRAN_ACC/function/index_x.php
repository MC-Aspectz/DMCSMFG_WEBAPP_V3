...
// ------------------------- CALL Langauge -------------------//
$loadApp = getSystemData('SEARCHPURRECTRAN_ACC');
if(empty($loadApp)) {
    $loadApp = $syslogic->getLoadApp('SEARCHPURRECTRAN_ACC');
    $syslogic->ProgramRundelete('SEARCHPURRECTRAN_ACC');
    setSystemData('SEARCHPURRECTRAN_ACC', $loadApp);
}
//  else {
//     $setLoadApp = $syslogic->setLoadApp('SEARCHPURRECTRAN_ACC');
// }
