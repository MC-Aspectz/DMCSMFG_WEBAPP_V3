...
<head>
    ...
    <title><?=$_SESSION['APPNAME'].' - '.$data['DRPLANG']['APPCODE']['SEARCHSALETRANFORDC2_ACC']; ?></title>
</head>
<body>
<main>
            ...
            <table id="table_result" class="w-full border-collapse border border-slate-500">
                <thead class="w-full bg-gray-100">
                    <tr class="flex w-full divide-x csv-row">
                        ...
                        <th class="w-2/12 text-center csv-col">
                            <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=checklang('TOTALAMOUNT'); ?></span>
                        </th>
                        <th class="w-1/12 text-center csv-col">
                ...
                foreach ($tdata as $item) {  ?>
                    <tr class="flex w-full p-0 divide-x csv-row">
                        ...
                        <td class="h-6 w-1/12 pl-1 text-sm csv-col"><?=$item['SALETRANINSPDT'] ?></td>
                        <td class="h-6 w-2/12 pl-1 text-sm csv-col"><?=$item['SALEORDERNO'] ?></td>
                        <td class="h-6 w-1/12 pl-1 text-sm csv-col"><?=$item['CUSTOMERCD'] ?></td>
                        <td class="h-6 w-3/12 pl-1 text-sm csv-col"><?=$item['CUSTOMERNAME'] ?></td>
                        <td class="h-6 w-2/12 pl-1 text-sm csv-col"><?=$item['SALETRANAMT'] ?></td>
                        <td class="h-6 w-1/12 pl-1 text-sm csv-col"><?php foreach ($accststatus as $i => $v) { echo $item['STATUS'] == $i ? $v : ''; } ?></td>
                    </tr><?php }
                ...
                <div class="modal-body">
                    <table class="w-full border-collapse border border-slate-500" id="tabel_modal" rules="cols" cellpadding="3" cellspacing="1" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=checklang('INVDATE'); ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="INVDATE" style="background-color:#ffe6cc;"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=checklang('TOTALAMOUNT'); ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="TOTALAMOUNT" style="background-color:#ffe6cc;"></td>
                            </tr>
                          <tr>
