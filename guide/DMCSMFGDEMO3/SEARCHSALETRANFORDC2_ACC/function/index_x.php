...
$javaFunc = new SaleTranForDC2ACC;
$minrow = 0;
$maxrow = 11;
...
if(isset($_POST['search'])) {
	...
	// print_r($Param);
  	$tdata = $javaFunc->searchSaleTran($Param);
	// echo '<pre>';
 //  	print_r($tdata);
	// echo '</pre>';
}
...
// ------------------------- CALL Langauge -------------------//
$loadApp = getSystemData('SEARCHSALETRANFORDC2_ACC');
if(empty($loadApp)) {
    $loadApp = $syslogic->getLoadApp('SEARCHSALETRANFORDC2_ACC');
    $syslogic->ProgramRundelete('SEARCHSALETRANFORDC2_ACC');
    setSystemData('SEARCHSALETRANFORDC2_ACC', $loadApp);
}
//  else {
//     $setLoadApp = $syslogic->setLoadApp('SEARCHSALETRANFORDC2_ACC');
// }
