...
<body>
  ...
  <form class="form" method="POST" id="loginhistoryaccountrd" name="loginhistoryaccountrd" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
            ...
            <table class="table-head table-striped search_table" id="table" rules="cols" cellpadding="3" cellspacing="1">
              <thead>
                <tr class="table-secondary">
                  ...
                  <th class="th-class width15"><?=$data['TXTLANG']['LINENO']; ?></th>
                  <th class="th-class width20"><?=$data['TXTLANG']['ACCOUNTCD']; ?></th>
                  <th class="th-class width10"><?=$data['TXTLANG']['ACCOUNTNAME']; ?></th>
                  <th class="th-class width15"><?=$data['TXTLANG']['DEBIT_AMOUNT']; ?></th>
                  <th class="th-class width20"><?=$data['TXTLANG']['CREDIT_AMOUNT']; ?></th>
              ...
              <tbody>
                <?php if(!empty($data['LHACRD']))  {
                  foreach ($data['LHACRD'] as $key => $value) {
                    if(is_array($value)) {
                      $minrow = count($data['LHACRD']);?>
                      <tr class="tr_border table-secondary">
                                  ...
                                  <td class="td-class"><?=$value['LINENO'] ?></td>
                                  <td class="td-class"><?=$value['ACCCD'] ?></td>
                                  <td class="td-class"><?=$value['ACCNAME'] ?></td>
                                  <td class="td-class"><?=$value['DRAMT'] ?></td>
                                  <td class="td-class"><?=$value['CRAMT'] ?></td>
                      ...
                      $minrow = 1; ?>
                      <tr class="tr_border table-secondary">
                        <td class="td-class"><?=$data['LHACRD']['IFNO'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['REFNO'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['TIMESTAMP'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['STAFFCD'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['STAFFNAME'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['DIVISIONCD'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['DIVISIONNAME'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['LINENO'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['ACCCD'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['ACCNAME'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['DRAMT'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['INSERTFLG'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['UPDATEFLG'] ?></td>
                        <td class="td-class"><?=$data['LHACRD']['CANCELFLG'] ?></td>
              ...
              <div class="font-size14"><?=$data['TXTLANG']['ROWCOUNT']; ?>&emsp;<?=!empty($data['LHACRD']) ? count($data['LHACRD']) : 0 ?></div>
            </div>
          </div>
        </div>
