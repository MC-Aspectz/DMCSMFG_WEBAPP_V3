...
if(!empty($_POST)) {
    ...
    if(isset($_POST['search'])) {
        ...
        $PRGCDS = $_POST['PRGCDS'];
        $query = $javaFunc->SearchLoginHisRd($STARTDATE1,$STARTDATE2,$STAFFCDS,$PRGCDS);
        $data['LHRD'] = $query;
       // $data = $data['LHRD'];
       //print_r($data['LHRD']);
...
// $STAFFCDS = isset($_POST['STAFFCDS']) ? $_POST['STAFFCDS']: '';
// $PRGCDS = isset($_POST['PRGCDS']) ? $_POST['PRGCDS']: '';
$LoginHisrd = $javaFunc->LoginHisRd($STARTDATE1,$STARTDATE2,$STAFFCDS,$PRGCDS);
$data['LHRD'] = $LoginHisrd;
//print_r($STARTDATE1);
if(!empty($LoginHisrd)) {
    setSessionArray($data);  
}
...
function setSessionArray($arr){
    $keepField = array("SYSPVL", "TXTLANG", 'DRPLANG', 'LHRD');
    foreach($arr as $k => $v){
