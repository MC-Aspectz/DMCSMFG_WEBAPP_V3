<?php 
require_once('./function/index_x.php');	TAXINVprint(); $index = isset($data['PRINTDYNAMIC']) ? array_key_first($data['PRINTDYNAMIC']) : 0; ?>
<html>
<head>
		...
		foreach ($data['ITEMPAGE'] as $index => $value) { ?>
			<div class="page">
				...
				<div class="flex">
					...
					<label class="label-justify-center"><?=$value['RPTTITLE']?></label>
