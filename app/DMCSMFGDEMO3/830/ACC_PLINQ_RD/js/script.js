...
// form
const form = document.getElementById('accProfitAndLossRd');
...
async function exportCSV() {
  // Variable to store the final csv data
    ...
    var csv_data = ['Period,' + yearname + ',' + monthname + ',→,' + yearname2 + ',' + monthname2 + ',' + accyname2];
    // Get each row data
...
async function printed() {
  ...
  data.append('action', 'Print_PL');
  await axios.post('../ACC_PLINQ_RD/function/index_x.php', data)
    .then((response) => {
...
async function unsetSession(form) {
    ...
    data.append('systemName', 'ACC_PLINQ_RD');
    await axios.post('../ACC_PLINQ_RD/function/index_x.php', data)
    .then(response => {
        // console.log(response.data)
        clearForm(form);
...
async function clearForm(form) {
    ...
    // refresh
    window.location.href = '../ACC_PLINQ_RD/';
...
//     await keepData();
//     if(type == 'PL') {
//         var popupWindow = window.open('../ACC_PLINQ_RD/print.php', '_blank', "width=800, height=800");
//     }
