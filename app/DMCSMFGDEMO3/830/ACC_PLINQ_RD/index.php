...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto overflow-x-hidden paragraph px-2">
            ...
            <form class="w-full" method="POST" action="" id="accProfitAndLossRd" name="accProfitAndLossRd" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
                ...
                <div class="flex mb-1 px-2">
                    ...
                    <div class="flex w-5/12 justify-end">
                        ...
                        <select class="text-control text-[12px] shadow-md border mr-4 px-3 h-7 w-5/12 text-left rounded-xl border-gray-300" 
                                id="ACCY" name="ACCY">
                                <option value=""></option>
                        ...
                        <thead class="sticky top-0 bg-gray-50">
                            <tr class="border border-gray-600">
                                ...
                                <th class="px-5 text-center border border-slate-700">
                                    <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=checklang('THIS_PERIOD')?></span>
                                </th>
