...
class AccAdjustVoucherOnlyTHA extends Syslogic {

    public function __construct() {
        $this->APPCODE = 'ACC_ADJUSTVO_ONLY_THA';
    ...
    public function getRefHeader($REFBOOKORDERNO) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.THA.AccAdjustVoucherOnlyEntryRD.getRefHeader', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function load() {
        $Param = array();
        $cmd = GetRequestData($Param, 'acc.THA.AccAdjustVoucherOnlyEntryRD.load', $this->APPCODE, '');
        $data = Execute($cmd, $errorMessage);
        return $data;
    }
}
