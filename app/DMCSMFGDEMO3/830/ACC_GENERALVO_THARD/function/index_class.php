...
class AccGeneralVoucherTHARD extends Syslogic {

    public function __construct() {
        $this->APPCODE = 'ACC_GENERALVO_THARD';
    }
    ...
    public function getInpStf($INP_STFCD) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getInpStf', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getDiv($DIVISIONCD) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getDiv', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function setCss($CSSTYPE) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.THA.AccGeneralVoucherEntryRD.setCss', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getStaff($STAFFCODE) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getStaff', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getSupllier($SUPPLIERCD) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getSupllier', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getCustomer($CUSTOMERCODE) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.THA.AccGeneralVoucherEntryRD.getCustomer', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getDetail($BOOKORDERNO, $ACCY, $I_CURRENCY, $CURRENCY1) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getDetail', $this->APPCODE, '');
    ...
    public function chkAccCd($ACC_CD, $CSSTYPE, $SUPPLIERCD) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.chkAccCd', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getAmt($AMT, $DC_TYPE, $EXRATE) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getAmt', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getAcc($DC_TYPE, $ACC_CD, $AMT, $I_CURRENCY, $CURRENCY1, $EXRATE) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getAcc', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getExRate($I_CURRENCY, $CURRENCY1, $AMT, $DC_TYPE, $ISSUEDATE) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getExRate', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function commitRemark($ACCTRANREMARK) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.commitRemark', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function getRecur($RECURCD) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.getRecur', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function searchRecur($RECURCD) {
        try {
            $Param = array('RECURCD' => $RECURCD);
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.searchRecur', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function commitRecurring($RECURCD, $DVWDETAIL) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntry.commitRecurring', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function chkCommitData($TTL_AMT1, $TTL_AMT2) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.chkCommitData', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function commit($Param) {
        try {
            $cmd = GetRequestData($Param, 'acc.AccGeneralVoucherEntryRD.commit', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function JVprintCheck($BOOKORDERNO, $REPRINTREASON) {
        try {
            ...
            $cmd = GetRequestData($Param, 'acc.THA.AccGeneralVoucherEntryRD.JVprintCheck', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function JVprintStatic($Param) {
        try {
            $cmd = GetRequestData($Param, 'acc.THA.AccGeneralVoucherEntryRD.JVprintStatic', $this->APPCODE, '');
            $data = Execute($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function JVprintDynamic($Param) {
        try {
            $cmd = GetRequestData($Param, 'acc.THA.AccGeneralVoucherEntryRD.JVprintDynamic', $this->APPCODE, '');
            $data = ExecuteAll($cmd, $errorMessage);
            return $data;
        } catch (Exception $ex) {
            return $ex->getMessage();
    ...
    public function load() {
        $Param = array();
        $cmd = GetRequestData($Param, 'acc.THA.AccGeneralVoucherEntryRD.load', $this->APPCODE, '');
        $data = Execute($cmd, $errorMessage);
        return $data;
    }
}
