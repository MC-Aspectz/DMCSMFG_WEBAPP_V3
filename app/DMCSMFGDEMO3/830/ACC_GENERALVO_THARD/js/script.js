...
ACCBOKGUIDE9.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/ACCBOKGUIDE9/index.php?page=ACC_GENERALVO_THARD', 'authWindow', 'width=1200,height=600');});
SEARCHDIVISION.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHDIVISION/index.php?page=ACC_GENERALVO_THARD', 'authWindow', 'width=1200,height=600');});
SEARCHCDDATA.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHCDDATA/index.php?page=ACC_GENERALVO_THARD', 'authWindow', 'width=1200,height=600');});
SEARCHRECUR.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHRECUR/index.php?page=ACC_GENERALVO_THARD', 'authWindow', 'width=1200,height=600');});
SEARCHACCOUNT.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ACC_GENERALVO_THARD', 'authWindow', 'width=1200,height=600');});
...
// form
const form = document.getElementById('general_voucher');
...
async function getSearch(code, value) {
  $('#loading').show();
  return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/830/ACC_GENERALVO_THARD/index.php?'+code+'=' + value;
}
...
function selectRow() {
    $(document).on('click', '.gvc tbody tr', function(event) {
...
//     await keepData();
//     if(type == 'JV') {
//         var popupWindow = window.open('../ACC_GENERALVO_THARD/general_voucher.php', '_blank', 'width=800, height=800');
//     }
...
async function unsetSession(form) {
    ...
    data.append('systemName', 'ACC_GENERALVO_THARD');
...
async function clearForm(form) {
    ...
    // refresh
    window.location.href = '../ACC_GENERALVO_THARD/';
