...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto overflow-x-hidden paragraph px-2">
            ...
            <form class="w-full" method="POST" id="general_voucher" name="general_vaoucher" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
                            ...
                            <details id="search-card" class="p-1.5 w-full align-middle"><!-- open -->
                                ...
                                <div class="flex mb-1">
                                    <div class="flex w-6/12 px-2">
                                        ...
                                        <div class="relative w-4/12 mr-4">
                                ...
                                <div class="flex mb-1">
                                    <div class="flex w-6/12 px-2">
                                        ...
                                        <div class="relative w-4/12 mr-4 read">
                                ...
                                <div class="flex mb-1">
                                    <div class="flex w-8/12 px-2">
                                        ...
                                        <?php if(!empty($data['SYSVIS_STAFFCODE']) && $data['SYSVIS_STAFFCODE'] == 'T') { ?>
                                            <div class="relative w-3/12 mr-1" id="STAFF">
                                                <input type="text" class="text-control text-sm shadow-md border z-20 rounded-xl h-7 w-full py-2 px-3 text-gray-700 border-gray-300"
                                        ...
                                        <?php } else if(!empty($data['SYSVIS_SUPPLIERCD']) && $data['SYSVIS_SUPPLIERCD'] == 'T') { ?>
                                            <div class="relative w-3/12 mr-1" id="SUPPLIER">
                                                <input type="text" class="text-control text-sm shadow-md border z-20 rounded-xl h-7 w-full py-2 px-3 text-gray-700 border-gray-300"
                                        ...
                                        <?php } else { ?>
                                            <div class="relative w-3/12 mr-1" id="CUSTOMER">
                                                <input type="text" class="text-control text-sm shadow-md border z-20 rounded-xl h-7 w-full py-2 px-3 text-gray-700 border-gray-300"
                ...
                <div id="table-area" class="overflow-scroll block h-[320px]"> 
...
<script type="text/javascript">   
    $(document).ready(function() {
        ...
        } // $('#CSSTYPE').attr('style', 'pointer-events: none').css('background-color', 'whitesmoke');
        ...
        details.addEventListener('toggle', function() {
            if (!details.open) {
                tablearea.classList.remove('h-[320px]');
                tablearea.classList.add('h-[440px]');
                maxrow = 15;
            } else {
                tablearea.classList.remove('h-[440px]');
                tablearea.classList.add('h-[320px]');
                maxrow = 10;
            }
            emptyRows(maxrow);
        });
    ...
    function calculateDVW() {
        ...
        if(item != '') {
            ...
            $('#TTL_AMT1').val(numberWithComma(accamt1.toFixed(2)));
            $('#TTL_AMT2').val(numberWithComma(accamt2.toFixed(2)));
        }        
    }
