...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto overflow-x-hidden paragraph px-2">
            ...
            <form class="w-full" method="POST" id="pettycashvoucher" name="pettycashvoucher" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
                                ...
                                <div class="flex mb-1">
                                    ...
                                    <div class="flex w-4/12 px-2">
                                        ...
                                        <div class="flex w-4/12 justify-end">
                                            <button type="button" class="btn text-color inline-flex items-center border-2 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-3xl text-sm px-4 py-1 text-center" id="SEARCH" name="SEARCH" onclick="getDetail();"><?=checklang('SEARCH')?>
                ...
                <div id="table-area" class="overflow-scroll block h-[330px]"> 
                    <table id="table" class="w-full border-collapse border border-slate-500 divide-gray-200 pcv" rules="cols" cellpadding="3" cellspacing="1">
                        ...
                        if(!empty($data['ITEM'])) { $minrow = count($data['ITEM']);
                            foreach ($data['ITEM'] as $key => $value) { ?>
                                <tr class="divide-y divide-gray-200" id="rowId<?=$key?>">
                                    ...
                                    <td class="h-6 w-3/12 pl-1 text-sm border border-slate-700 text-left whitespace-nowrap" id="ACC_NM_TD<?=$key?>"><?=isset($value['ACC_NM']) ? $value['ACC_NM']:'' ?></td>
                                    ...
                                    <input class="td-param" type="hidden" id="ACC_CD<?=$key?>" name="ACC_CDA[]" value="<?=isset($value['ACC_CD']) ? $value['ACC_CD']: '' ?>">
                                    <input class="td-param" type="hidden" id="ACC_NM<?=$key?>" name="ACC_NMA[]" value="<?=isset($value['ACC_NM']) ? $value['ACC_NM']: '' ?>">
                                    <input class="td-param" type="hidden" id="ACCTRANREMARK<?=$key?>" name="ACCTRANREMARKA[]" value="<?=isset($value['ACCTRANREMARK']) ? $value['ACCTRANREMARK']: '' ?>">
                                    <input class="td-param" type="hidden" id="ACCAMT1<?=$key?>" name="ACCAMT1A[]" value="<?=isset($value['ACCAMT1']) ? $value['ACCAMT1']: '' ?>">
                                    <input class="td-param" type="hidden" id="ACCAMT2<?=$key?>" name="ACCAMT2A[]" value="<?=isset($value['ACCAMT2']) ? $value['ACCAMT2']: '' ?>">
                                    <input class="td-param" type="hidden" id="SECTION1<?=$key?>" name="SECTION1A[]" value="<?=isset($value['SECTION1']) ? $value['SECTION1']: '' ?>">
                                    <input class="td-param" type="hidden" id="PROJECTNO<?=$key?>" name="PROJECTNOA[]" value="<?=isset($value['PROJECTNO']) ? $value['PROJECTNO']: '' ?>">
                                    <input class="td-param" type="hidden" id="ADJFLAG<?=$key?>" name="ADJFLAGA[]" value="<?=isset($value['ADJFLAG']) ? $value['ADJFLAG']: '' ?>">
                                    <input class="td-param" type="hidden" id="DC_TYPE<?=$key?>" name="DC_TYPEA[]" value="<?=isset($value['DC_TYPE']) ? $value['DC_TYPE']: '' ?>">
                                    <input class="td-param" type="hidden" id="CURRENCY1<?=$key?>" name="CURRENCY1A[]" value="<?=isset($value['CURRENCY1']) ? $value['CURRENCY1']: '' ?>">
                                    <input class="td-param" type="hidden" id="I_CURRENCY<?=$key?>" name="I_CURRENCYA[]" value="<?=isset($value['I_CURRENCY']) ? $value['I_CURRENCY']: '' ?>">
                                    <input class="td-param" type="hidden" id="EXRATE<?=$key?>" name="EXRATEA[]" value="<?=isset($value['EXRATE']) ? $value['EXRATE']: '' ?>">
                                    <input class="td-param" type="hidden" id="AMT<?=$key?>" name="AMTA[]" value="<?=isset($value['AMT']) ? $value['AMT']: '' ?>">
                                    <input class="td-param" type="hidden" id="WHTAXTYP<?=$key?>" name="WHTAXTYPA[]" value="<?=isset($value['WHTAXTYP']) ? $value['WHTAXTYP']: '' ?>">
                                    <input class="td-param" type="hidden" id="TAXINVOICENO<?=$key?>" name="TAXINVOICENOA[]" value="<?=isset($value['TAXINVOICENO']) ? $value['TAXINVOICENO']: '' ?>">
                                </tr><?php
                            }
                        }
                ...
                <div class="flex p-2">
                    ...
                    <div class="flex w-10/12">
                       <label class="text-color block text-sm w-2/12 pt-1"><?=checklang('RECURCODE')?></label>
                        ...
                        <button type="button" class="btn text-color border-2 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-3xl text-sm px-4 py-1 text-center mx-2"
                                id="SAVEREC" name="SAVEREC" onclick="return questionDialog(3, '<?=lang('question5')?>', '<?=lang('yes'); ?>', '<?=lang('nono'); ?>');"><?=checklang('SAVE'); ?></button>
                    </div>
                </div>
                        ...
                        <div class="justify-between px-2 border border-gray-200 rounded-xl shadow-sm">
                            ...
                            <div class="flex my-1">
                                <div class="flex w-5/12 px-2">
                                    ...
                                    <button type="button" class="btn text-color border-2 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-3xl text-sm px-4 py-1 mr-2 text-center"
                                        id="PETTYVOUCHER" name="PETTYVOUCHER"><?=checklang('PETTYVOUCHER'); ?></button>
                                </div>
                            ...
                            <div class="flex mb-1 px-2">
                                ...
                                <button type="button" class="btn text-color border-2 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-3xl text-sm px-5 py-1 text-center"
                                        id="SAVE" name="SAVE" onclick="return questionDialog(4, '<?=lang('question6')?>', '<?=lang('yes'); ?>', '<?=lang('nono'); ?>');"><?=checklang('SAVE'); ?></button>
                            </div>  
                            </details>
                        </div>
                        <!-- End Header -->
...
<script type="text/javascript">   
    $(document).ready(function() {
        ...
        if(csstype == 'F') { $('#CSSTYPE').attr('style', 'pointer-events: none').css('background-color', 'whitesmoke'); } // $('#CSSTYPE').attr('style', 'pointer-events: none').css('background-color', 'whitesmoke');
        ...
        if($('#BOOKORDERNO').val() != '') { document.getElementById('PETTYVOUCHER').disabled = false; }
        ...
        INSERT.click(function() {
            ...
            cols += '<td class="h-6 w-3/12 pl-1 text-sm border border-slate-700 text-left whitespace-nowrap" id="ACC_NM_TD'+index+'">'+ $('#ACC_NM').val() +'</td>';
            ...
            cols += '<input class="td-param" type="hidden" id="ROWNO'+index+'" name="ROWNOA[]" value="'+index+'">';
            cols += '<input class="td-param" type="hidden" id="ACC_CD'+index+'" name="ACC_CDA[]" value="'+ $('#ACC_CD').val() +'">';
            cols += '<input class="td-param" type="hidden" id="ACC_NM'+index+'" name="ACC_NMA[]" value="'+ $('#ACC_NM').val() +'">';
            cols += '<input class="td-param" type="hidden" id="ACCTRANREMARK'+index+'" name="ACCTRANREMARKA[]" value="'+ $('#ACCTRANREMARK').val() +'">';
            cols += '<input class="td-param" type="hidden" id="ACCAMT1'+index+'" name="ACCAMT1A[]" value="'+ $('#ACCAMT1').val() +'">';
            cols += '<input class="td-param" type="hidden" id="ACCAMT2'+index+'" name="ACCAMT2A[]" value="'+ $('#ACCAMT2').val() +'">';
            cols += '<input class="td-param" type="hidden" id="SECTION1'+index+'" name="SECTION1A[]" value="'+ document.getElementById('SECTION1').value +'">';
            cols += '<input class="td-param" type="hidden" id="PROJECTNO'+index+'" name="PROJECTNOA[]" value="'+ $('#PROJECTNO').val() +'">';
            cols += '<input class="td-param" type="hidden" id="ADJFLAG'+index+'" name="ADJFLAGA[]" value="">';
            cols += '<input class="td-param" type="hidden" id="DC_TYPE'+index+'" name="DC_TYPEA[]" value="'+ $('#DC_TYPE').val() +'">';
            cols += '<input class="td-param" type="hidden" id="CURRENCY1'+index+'" name="CURRENCY1A[]" value="'+ document.getElementById('CURRENCY1').value +'">';
            cols += '<input class="td-param" type="hidden" id="I_CURRENCY'+index+'" name="I_CURRENCYA[]" value="'+ document.getElementById('I_CURRENCY').value +'">';
            cols += '<input class="td-param" type="hidden" id="EXRATE'+index+'" name="EXRATEA[]" value="'+ $('#EXRATE').val() +'">';
            cols += '<input class="td-param" type="hidden" id="AMT'+index+'" name="AMTA[]" value="'+ $('#AMT').val() +'">';
            cols += '<input class="td-param" type="hidden" id="WHTAXTYP'+index+'" name="WHTAXTYPA[]" value="'+ $('#WHTAXTYP').val() +'">';
            cols += '<input class="td-param" type="hidden" id="TAXINVOICENO'+index+'" name="TAXINVOICENOA[]" value="'+ $('#TAXINVOICENO').val() +'">';
    ...
    function HandlePopupResult(code, result) {
        ...
        } else if(code == 'RECURCD' || code == 'BOOKORDERNO') {
    ...
    function actionDialog(type) {
        if(type == 1) {
            ...
            return alertWarning('<?=lang('validation3'); ?>', '<?=lang('yes'); ?>', '<?=lang('nono'); ?>');  
        } else if(type == 6) {
            return alertWarning('<?=lang('validation4'); ?>', '<?=lang('yes'); ?>', '<?=lang('nono'); ?>');
        } else if(type == 7) {
            return alertWarning('<?=lang('validation5'); ?>', '<?=lang('yes'); ?>', '<?=lang('nono'); ?>');
        } else {
