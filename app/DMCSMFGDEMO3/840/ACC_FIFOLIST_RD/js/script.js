...
// form
const form = document.getElementById('acc_fifolist_rd');
...
async function commit(method) {
    ...
    await axios.post('../ACC_FIFOLIST_RD/function/index_x.php', data)
    .then(response => {
        // console.log(response.data)
...
async function clearForm(form) {
    ...
    // refresh
    window.location.href = '../ACC_FIFOLIST_RD/';
...
function printReport() {   
    var popupWindow = window.open('../ACC_FIFOLIST_RD/print.php', '_blank', 'width=auto, height=auto');
