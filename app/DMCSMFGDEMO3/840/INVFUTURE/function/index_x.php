...
if(!empty($_POST)) {
    if (isset($_POST['action'])) {
        ...
        if ($_POST['action'] == 'SEARCH') { searchItem(); }
    }
}
//--------------------------------------------------------------------------------
...
function searchItem() {
    ...
    $data['ITEM'] = array();
    $searchfunc = new INVFuture;
    $ITEMCD = isset($_POST['ITEMCD']) ? $_POST['ITEMCD']: '';
    $searchItem = $searchfunc->searchItem($ITEMCD);
    // echo '<pre>';
    // print_r($searchItem);
    // echo '</pre>';
    if(!empty($searchItem)) {
...
function setSessionArray($arr) {
    $keepField = array( 'SYSPVL', 'TXTLANG', 'DRPLANG', 'ITEM', 'ITEMCD', 'ITEMNAME', 'ITEMSPEC', 'ITEMDRAWNUMBER', 'ONHANDQTY', 'UNIT');
    foreach($arr as $k => $v) {
