...
<div id="printReport" >
    ...
    <table class="table" style="border:none !important;">
		<thead>
			<tr class="table-tr ">
                <td class="td-label-width10 border-head">Voucher No.</td>
                <td class="td-label-width10 border-head">Line</td>
                <td class="td-label-width10 border-head">Date</td>
                <td class="td-label-width10 border-head">Process Type</td>
                <td class="td-label-width10 border-head">Location Type</td>
                <td class="td-label-width10 border-head">Location Code</td>
                <td class="td-label-width10 border-head">Location Name</td>
                <td class="td-label-width10 border-head">Receiving Qty.</td>
                <td class="td-label-width10 border-head">Supply Qty.</td>
                <td class="td-label-width10 border-head">Voucher Date</td>
                <td class="td-label-width10 border-head">OrderNo.</td>
                <td class="td-label-width10 border-head">Comment</td>
			</tr>
		</thead>
		<tbody><?php 
