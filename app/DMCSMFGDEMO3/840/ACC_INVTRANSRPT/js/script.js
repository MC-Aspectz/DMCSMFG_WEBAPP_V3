...
// form
const form = document.getElementById('acc_invtransrpt');
...
async function commit(method) {
    ...
    await axios.post('../ACC_INVTRANSRPT/function/index_x.php', data)
    .then(response => {
        // console.log(response.data)
...
async function clearForm(form) {
    ...
    // refresh
    window.location.href = '../ACC_INVTRANSRPT/';
...
function printReport() {   
    var popupWindow = window.open('../ACC_INVTRANSRPT/print.php', '_blank', 'width=auto, height=auto');
