...
$data = array();
$javaFunc = new AccInvTransRpt;
$data = array();
$systemName = 'AccInvTransRpt';
// -- Table Max Row ----//
$minrow = 0;
$maxrow = 10;
$rowno = 0;
...
if(!empty($_GET)) {
    ...
    if(isset($_GET['refresh'])) {
        ...
        $query = $javaFunc->getInvTrans($DVPERIOD,$YEAR,$MONTH,$YEAR2,$MONTH2,$ITEMCD,$ITEMCD2);
        $data['INV'] = $query;
        setSessionArray($data); 
    }
...
function setSessionArray($arr){
    $keepField = array('INV', 'DVPERIOD', 'YEAR', 'MONTH', 'YEAR2', 'MONTH2', 'ITEMCD', 'ITEMCD2', 'RPTDOCEN', 'RPTDOCTH');
    foreach($arr as $k => $v){
