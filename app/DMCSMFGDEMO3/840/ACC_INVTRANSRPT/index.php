...
<body>
    ...
    <form class="form" method="POST" id="acc_invtransrpt" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
                        ...
                        foreach ($data['INV'] as $key => $value) {
                            ...
                            //   print_r($value);
                             ?>
                                ...
                                $minrow = 1; 
                                ++$rowno;
                                // print_r('2'); WKITEMCD,WKITEMNAME,WKITEMUNITTYP,WKISSUEDT,WKTRANNO,WKREFNO,WKDQTY,WKCQTY,WKRQTY,SPACE
                                ?>
                                    <tr class="tr_border table-secondary">
                                        ...
                                        <td class="td-class csv"><?=isset($data['INV']['WKISSUEDT']) ? date('d/m/Y', strtotime($data['INV']['WKISSUEDT'])): ''  ?></td>
                                        <td class="td-class csv"><?=$data['INV']['WKTRANNO'] ?></td>
                                        <td class="td-class csv"><?=$data['INV']['WKREFNO'] ?></td>
                                        <td class="td-class csv"><?=$data['INV']['WKDQTY'] ?></td>
                                        <td class="td-class csv"><?=$data['INV']['WKCQTY'] ?></td>
