...
// form
const form = document.getElementById('acc_invbalancerpt');
...
async function commit(method) {
    ...
    await axios.post('../ACC_INVBALANCERPT/function/index_x.php', data)
    .then(response => {
        // console.log(response.data)
...
async function clearForm(form) {
    ...
    // refresh
    window.location.href = '../ACC_INVBALANCERPT/';
...
function printReport() {   
    var popupWindow = window.open('../ACC_INVBALANCERPT/print.php', '_blank', 'width=auto, height=auto');
