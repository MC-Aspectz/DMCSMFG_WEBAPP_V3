...
$javaFunc = new AccInvBalanceRpt;
$data = array();
$systemName = 'AccInvBalanceRpt';
// -- Table Max Row ----//
$minrow = 0;
$maxrow = 10;
$rowno = 0;
//DVPERIOD,YEAR,MONTH,YEAR2,MONTH2,ITEMCD,ITEMCD2,RPTDOCEN,RPTDOCTH
$DVPERIOD ='';
$YEAR ='';
$MONTH = '';
$ITEMCD = '';
...
if(!empty($_POST)) {
   ...
   if(isset($_POST['search'])) {
        ...
        $query = $javaFunc->getInvBalance('', $_POST['YEAR'],$_POST['MONTH'],
...
if(!empty($_GET)) {
    ...
    if(isset($_GET['refresh'])) {
        ...
        $query = $javaFunc->getInvBalance($DVPERIOD,$YEAR,$MONTH,$ITEMCD,$ITEMCD2);
        $data['INV'] = $query;
        setSessionArray($data); 
    }
...
function setSessionArray($arr){
    $keepField = array('INV', 'DVPERIOD', 'YEAR', 'MONTH', 'ITEMCD', 'ITEMCD2', 'RPTDOCEN', 'RPTDOCTH');
    foreach($arr as $k => $v){
