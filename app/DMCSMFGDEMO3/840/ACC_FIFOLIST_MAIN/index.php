...
<body>
    ...
    <form class="form" method="POST" id="acc_fifolist_main" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
        ...
        <div class="d-flex p-2">
            <div class="flex">
                ...
                <div class="flex .col45">
                    <!-- <input class="form-control width60" type="hidden" id="DVPERIOD" name="DVPERIOD" value="<?=isset($data['DVPERIOD']) ? $data['DVPERIOD']: ''?>" /> -->
                    <!-- <input class="form-control width60" id="DVPERIOD" name="DVPERIOD" value="<?=isset($data['DVPERIOD']) ? $data['DVPERIOD']: ''?>" /> -->
                </div>
            </div>
        </div>
        ...
        <div class="d-flex p-2">
            <div class="flex">
                <div class="flex .col55">
                    ...
                    <input class="form-control width50" type="text" id="ITEMNAME" name="ITEMNAME" value="<?=isset($data['ITEMNAME']) ? $data['ITEMNAME']: ''?>" readonly/>
                </div>        
...
const search_icon = [guideindex1,search];
