...
SEARCHSALEORDERDETAIL.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHSALEORDERDETAIL/index.php?page=NEWSHIPREQUESTENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHCUSTOMER.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHCUSTOMER/index.php?page=NEWSHIPREQUESTENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHDIVISION.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHDIVISION/index.php?page=NEWSHIPREQUESTENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHCATALOG.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHCATALOG/index.php?page=NEWSHIPREQUESTENTRY_MFG', 'authWindow', 'width=1200,height=600');});
...
// form
const form = document.getElementById('newShipRequestEntryMFG');
...
async function getSearch(code, value) {
    $('#loading').show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/200/NEWSHIPREQUESTENTRY_MFG/index.php?'+code+'=' + value;
}
...
async function getElement(code, value) {
    ...
    await axios.post('../NEWSHIPREQUESTENTRY_MFG/function/index_x.php', data)
    .then(response => {
...
async function unsetSession(form) {
    ...
    data.append('systemName', 'NEWSHIPREQUESTENTRY_MFG');
    await axios.post('../NEWSHIPREQUESTENTRY_MFG/function/index_x.php', data)
    .then(response => {
        // console.log(response.data)
        clearForm(form);
...
async function clearForm(form) {
    ...
    // refresh
    window.location.href = '../NEWSHIPREQUESTENTRY_MFG/';
    // emptyTable();
