...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto paragraph">
            ...
            <form class="w-full" method="POST" action="" id="newShipRequestEntryMFG" name="newShipRequestEntryMFG" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
                        ...
                        if(!empty($data['ITEM'])) { $minrow = count($data['ITEM']);
                            foreach($data['ITEM'] as $key => $value) { ?>
                                <tr class="divide-y divide-gray-200 row-id" id="rowId<?=$key?>">
                                    ...
                                    <td class="hidden"><input type="hidden" id="SALEORDERNUMBER<?=$key?>" name="SALEORDERNUMBER[]" value="<?=isset($value['SALEORDERNUMBER']) ? $value['SALEORDERNUMBER']: '' ?>"/></td>
                                    <td class="hidden">
                                    ...
                                    <td class="hidden"><input type="hidden" id="ORDERSTATUS<?=$key?>" name="ORDERSTATUS[]" value="<?=isset($value['ORDERSTATUS']) ? $value['ORDERSTATUS']: '' ?>"/></td> -->
                                </tr><?php
                            }
                        }
