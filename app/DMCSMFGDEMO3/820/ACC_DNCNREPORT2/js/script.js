...
async function printed() {
    ...
    data.append('action', 'printPur');
    await axios.post('../ACC_DNCNREPORT2/function/index_x.php', data)
    .then((response) => {
...
async function unsetSession(form) {
    ...
    data.append('systemName', 'ACC_DNCNREPORT2');
    await axios
      .post('../ACC_DNCNREPORT2/function/index_x.php', data)
      .then((response) => {
        // console.log(response.data)
        clearForm(form);
      })
...
// async function printed() {
//     await keepData();
//     var popupWindow = window.open('../ACC_DNCNREPORT2/print.php', '_blank', 'width=800, height=800');
