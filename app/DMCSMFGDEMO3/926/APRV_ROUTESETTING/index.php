...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto paragraph">
            ...
            <form class="form" method="POST" id="aprvRouteSetting" name="aprvRouteSetting" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
            ...
            <div class="flex mt-2 px-2">
                ...
                <div class="flex w-7/12 justify-between">
                    ...
                    <button type="button" id="END" class="btn text-color border-2 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-3xl text-sm px-5 py-1 text-center me-2 mb-1"
                            onclick="questionDialog(1, '<?=$lang['question1']?>', '<?=$lang['yes']; ?>', '<?=$lang['nono']; ?>');">END</button>
                </div>
            </div>
            </form>
        </main>
