...
if(!empty($_POST)) {
    if (isset($_POST['action'])) {
        ...
        if ($_POST['action'] == 'searchGrant') { searchGrant(); }
    }
}
//--------------------------------------------------------------------------------
...
function searchGrant() {
    $javaGrant = new GroupView;
    $searchGrant = $javaGrant->searchGrant($_POST['STAFFCD'], $_POST['APPPACK']);
    // $set = $javaGrant->set($_POST['STAFFCD'].','.$_POST['APPPACK']);
    echo json_encode($searchGrant);
}
...
function setSessionArray($arr){
    $keepField = array("SYSPVL", "TXTLANG", 'DRPLANG', 'APPPACK');
    foreach($arr as $k => $v){
