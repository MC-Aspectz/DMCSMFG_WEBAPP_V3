...
if(!empty($_POST)) {
    if(isset($_POST['SEARCH'])) {
        ...
        $data['STAFFNAME'] = isset($_POST['STAFFNAME']) ? $_POST['STAFFNAME']: '';
        $data['APPPACK'] = isset($_POST['APPPACK']) ? $_POST['APPPACK']: '';
        $queryAvailable = $javaFunc->searchAvailable($data['STAFFCD'], $data['APPPACK']);
        $queryGrant = $javaFunc->searchGrant($data['STAFFCD'], $data['APPPACK']);
...
function grant() {
    ...
    $grant = $javaGrant->grant($_POST['STAFFCD'], $_POST['APPPACK'], $_POST['APPCD1']);
...
function revoke() {
    ...
    $revoke = $javaRevoke->revoke($_POST['STAFFCD'], $_POST['APPPACK'], $_POST['APPCD2']);
...
function setSessionArray($arr){
    $keepField = array('SYSPVL', 'TXTLANG', 'DRPLANG', 'STAFFCD', 'STAFFNAME', 'APPPACK', 'AVAILABLE', 'GRANT');
    foreach($arr as $k => $v){
