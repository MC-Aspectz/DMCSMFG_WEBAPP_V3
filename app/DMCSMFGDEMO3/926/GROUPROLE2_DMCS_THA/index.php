          ...
          <form class="w-full" method="POST" id="grouprole" name="grouprole" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
            ...
            <div class="flex mb-1 px-2">
                <div class="flex w-9/12">
                  ...
                  <label class="text-color block text-sm w-2/12 pt-1 text-center"><?=checklang('APPPACK')?></label>
                  <select class="text-control shadow-md border mr-1 px-3 h-7 w-3/12 text-left text-[12px] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500 req"
