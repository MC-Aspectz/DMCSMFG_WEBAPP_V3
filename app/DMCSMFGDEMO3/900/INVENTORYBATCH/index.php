...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto paragraph">
            ...
            <form class="w-full" method="POST" id="inventorybatch" name="inventorybatch" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
                ...
                <div class="flex mb-1">
                    <div class="flex w-8/12 px-2">
                        ...
                        <input type="hidden" id="CHECKROWH" name="CHKINVMONTH[]" value="F"/>
                        <input class="mt-1" type="checkbox" id="CHECKROW" name="CHKINVMONTH[]" value="T" <?=isset($value['CHKINVMONTH']) && $value['CHKINVMONTH'] == 'T' ? 'checked' : '' ?>/>
                        <label class="text-color block text-sm w-8/12 pl-3 pt-1"><?=checklang('MSG_INVMONTH')?></label>
                    </div>
                    <div class="flex w-4/12 px-2"></div>
                </div>
