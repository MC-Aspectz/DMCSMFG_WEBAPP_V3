...
<head>
    ...
    <title><?php echo $lang['customermaster'].' - '.$lang['customerindex']; ?></title>
</head>
<body>
<!-- -------------------------------------------------------------------------------- -->
<!--  Menu  -->
    ...
    <div class="col-md-12">
        <div class="flex">
            <div class="flex col-first">
                ...
                <input class="width30 form-control" type="text" id="P1" name="P1" value="<?php  ?>"/>
                →
                <input class="width30 form-control" type="text" id="P1_1" name="P1_1" value="<?php  ?>"/>
        ...
        <div class="flex">
            <div class="flex col-first">
                <label class="label-width20"><?php echo $lang['customername']; ?></label>
        ...
        <div class="flex">
            <div class="flex col-first">
                ...
                <input class="width30 form-control" type="text" id="P3" name="P3" value="<?php ?>"/>
            </div>
            <div class="flex col-second"></div>
        </div>
        <div class="flex">
            <div class="flex col-first">
                <label class="label-width20"><?php echo $lang['ADDR']; ?></label>
                <input class="width30 form-control" type="text" id="P4" name="P4" value="<?php ?>"/>
            </div>
            <div class="flex col-second"></div>
        </div>
        <div class="flex">
            <div class="flex col-first">
                <label class="label-width20"><?php echo $lang['ADDR']; ?></label>
                <input class="width30 form-control" type="text" id="P5" name="P5" value="<?php  ?>"/>
            </div>
                ...
                <table class="table-head" rules="cols" id="table_result" cellpadding="3" cellspacing="1" >
                    <thead>
                        <tr class="th-class table-secondary">
                            <th style="text-align: left; padding-left: 1%;"><?php echo $lang['customercode']; ?></th>
                            <th style="text-align: center;"><?php echo $lang['customername']; ?></th>
                            <th style="text-align: center;"><?php echo $lang['postalcode']; ?></th>
                            <th style="text-align: left; padding-left: 1%;"><?php echo $lang['ADDR']; ?></th>
                            <th style="text-align: center;"><?php echo $lang['ADDR']; ?></th>
                            <th style="text-align: center;"><?php echo $lang['tel']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php if (!empty($tdata)) {
