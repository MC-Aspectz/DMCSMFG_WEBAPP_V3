...
<head>
    ...
    <title><?php echo $lang['itemmaster'].' - '.$lang['storageindex']; ?></title>
</head>
<body>
<!-- -------------------------------------------------------------------------------- -->
<!--  Menu  -->
<?php doMenu(); ?>
<!-- -------------------------------------------------------------------------------- -->
<form class="form" style="width: 80%;" method="POST" id="currencyindex" name="currencyindex" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
    <div class="col-md-12">
        <div class="flex">
            <div class="flex col-first">
                <label class="label-width20"><?php echo $lang['currency']; ?></label>
                ...
                <table class="table-head" rules="cols" id="table_result" cellpadding="3" cellspacing="1" >
                    <thead>
                        <tr class="th-class table-secondary">
                            <th style="text-align: left; padding-left: 1%; width: 15%;"><?php echo $lang['currencycd']; ?></th>
                            <th style="text-align: left; padding-left: 1%;"><?php echo $lang['decimalunit']; ?></th>
                            <th style="text-align: left; padding-left: 1%;"><?php echo $lang['decimaltotal']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php if (!empty($tdata)) {
                    ...
                    foreach ($tdata as $item) { ?>
                        <tr class="table-warning">
                            ...
                            <td class="td-class"><?php echo $item["STORAGECD"] ?></td>
                            <td class="td-class"><?php echo $item["STORAGENAME"] ?></td>
                        </tr>
                    <?php }
                  } ?>
                  </tbody>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
           <table class="table-head" id="tabel_modal" rules="cols" cellpadding="3" cellspacing="1" >
                ...
                <tbody>
                    <tr>
                        <td class="td-class" style="background-color:#ffe6cc;"><?php echo $lang["locationcd"] ?></td>
                        <td class="td-class" id="locationcd" style="background-color:#ffe6cc;"></td>
                    </tr>
                    <tr>
                        <td class="td-class"><?php echo $lang["locationname"] ?></td>
                        <td class="td-class" id="locationname"></td>
                    </tr>
                </tbody>
            </table>
            <br>
...
<script type="text/javascript">
    ...
    $('table#table_result tr').click(function () {
        ...
        $("#select_item").on('click', function() {
             window.location.href="index.php?locationcd=" + item.eq(1).text();
        });
    });
