...
<head>
    ...
    <title><?php echo $lang['customermaster'].' - '.$lang['cityindex']; ?></title>
</head>
<body>
<!-- -------------------------------------------------------------------------------- -->
<!--  Menu  -->
<?php doMenu(); ?>
<!-- -------------------------------------------------------------------------------- -->
<form class="form" style="width: 80%;" method="POST" id="cityindex" name="cityindex" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
    <div class="col-md-12">
        <div class="flex">
        ...
        <div class="flex">
        <div class="flex col-first">
                <label class="label-width20"><?php echo $lang['cityname']; ?></label>
                ...
                <table class="table-head" rules="cols" id="table_result" cellpadding="3" cellspacing="1" >
                    <thead>
                        <tr class="th-class table-secondary">
                            <th style="text-align: left; padding-left: 1%; width: 15%;"><?php echo $lang['citycd']; ?></th>
                            <th style="text-align: left; padding-left: 1%;"><?php echo $lang['cityindex']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php if (!empty($tdata)) {
