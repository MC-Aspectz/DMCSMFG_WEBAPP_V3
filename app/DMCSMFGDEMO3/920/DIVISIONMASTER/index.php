...
<body>
    ...
    <form class="form" method="POST" id="division_master" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
    <div class="col-md-12">
        
            <div class="flex">
           
            <div class="flex col-first">            
            <label hidden class="label-width27"><?=$data['TXTLANG']['BRANCH_TYPE'];?> </label>
            <!-- hidden -->
            <select class="width22 option-text form-select form-select-sm" id="DIVISIONTYP_S" name="DIVISIONTYP_S" hidden >
                        <option value=""></option>
                        <?php foreach ($fac as $key => $item) { ?>
                            <option value="<?php echo $key ?>" <?php echo (isset($data['DIVISIONTYP_S']) && $data['DIVISIONTYP_S'] == $key) ? 'selected' : '' ?>><?php echo $item ?></option>
                        <?php } ?>
          </select>
                            ...
                            if(is_array($value)) {
                             ...
                             ?>
                              <tr class="tr_border table-secondary">
                                ...
                                $minrow = 1; ?>
                                <tr class="tr_border table-secondary">
                                      <td class="td-class"><?=$data['DIV']['DIVISIONCD'] ?></td>
                                      <td class="td-class"><?=$data['DIV']['DIVISIONNAME'] ?></td>                                
        ...
        <div class="d-flex p-2">
            <div class="flex">
                <div class="flex .col55">
                    <label class="label-width27"><?=$data['TXTLANG']['DIVISIONCODE']; ?></label>
                    <input class="form-control width43 req" type="text" id="DIVISIONCD" name="DIVISIONCD"
                     value="<?=isset($data['DIVISIONCD']) ? $data['DIVISIONCD']: ''?>" required  />
        ...
        <div class="d-flex p-2">
            <div class="flex">
                <div class="flex .col55">
                    <label class="label-width27"><?=$data['TXTLANG']['DIVISIONNAME']?></label>
                     <input class="form-control width70 req" type="text" id="DIVISIONNAME" name="DIVISIONNAME" value="<?=isset($data['DIVISIONNAME']) ? $data['DIVISIONNAME']: ''?>" required />
                </div>
