		...
		<div class="page">
			<div class="flex">
				...
				<div class="justify-center">
					<div>
						<h3 class="title-bill">รายงานภาษีซื้อ</h3>
						<h5 class="label-text14">เดือน/ปีภาษี<?=isset($data['PRINTSTATIC']['MONTHY']) ? str_repeat('&emsp;', 2).$data['PRINTSTATIC']['MONTHY'] : ''?></h5>
					</div>
				</div>
			...
			<table class="table" style="margin-top: 0.5em;">
				<thead>
					<tr class="table-tr">
						<td class="td-label-width30"><--------------ใบกำกับภาษี --------------><br>ลำดับ<?=str_repeat('&emsp;', 1)?>วัน/เดือน/ปี<?=str_repeat('&emsp;', 1)?>เลขที่<?=str_repeat('&emsp;', 1)?>เลขควบคุมเอกสารภายใน</td>
	 					<td class="td-label-width15">ชื่อผู้ขายสินค้า/ผู้ให้บริการ<br><?=str_repeat('&emsp;', 1)?></td>
	 					<td class="td-label-width10">เลขประจำตัวผู้เสียภาษีอากรของ<br>ผู้ขายสินค้า/ผู้ให้บริการ</td>
						...
						if($value['PPAGE'] == $i)  { ?>
			                <tr class="tr-height">
								<td class="td-text-left">
									...
									<label><?=!empty($value['DMY']) ? str_repeat('&emsp;', 1).date_format(date_create($value['DMY']),"d/m/Y"): str_repeat('&emsp;', 5).str_repeat('&ensp;', 1); ?></label>
									<label><?=!empty($value['INVNO']) ? str_repeat('&emsp;', 1).$value['INVNO']: str_repeat('&emsp;', 1); ?></label>
									<label><?=!empty($value['NEWNUM']) ? str_repeat('&emsp;', 1).$value['NEWNUM']: str_repeat('&emsp;', 1); ?></label>
								</td>
			                ...
			                <tr>
								<td class="td-text-left" colspan="6">
									<label style="font-size: 12.0px;"><?=!empty($value['REMARKS']) ? str_repeat('&emsp;', 3).'หมายเหตุ > '.$value['REMARKS']: ''; ?></label>
								</td>
			                </tr>
			                <?php
			            }
