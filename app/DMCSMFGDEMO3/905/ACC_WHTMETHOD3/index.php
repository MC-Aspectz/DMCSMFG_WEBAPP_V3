...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto paragraph">
          ...
          <form class="w-full" method="POST" id="customerwithholdtax" name="customerwithholdtax" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
                      ...
                      <thead class="sticky top-0 bg-gray-50">
                          <tr class="border border-gray-600">
                              ...
                              <th class="px-6 text-center border border-slate-700">
                                  <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=checklang('RECMONEYCD')?></span>
                              </th>
                              <th class="px-3 text-center border border-slate-700">
                                  <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=checklang('ACC_CODE')?></span>
                              </th>
                              ...
                              <th class="px-6 text-center border border-slate-700">
                                  <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=checklang('RECEIVABLECD')?></span>
                              </th>
                          </tr>
                      </thead>
                        ...
                        if(!empty($data['CWH'])) {
                          ...
                          foreach ($data['CWH'] as $key => $value) { ?>
                              <tr class="divide-y divide-gray-200" id="rowId<?=$key?>">
                                  <td class="h-6 w-1/12 pl-1 text-sm border border-slate-700 text-left"><?=isset($value['WHTAXTYPE']) ? $value['WHTAXTYPE']: '' ?></td>
              ...
              <div class="flex flex-col">
                ...
                <div class="p-1 inline-block align-middle">
                    ...
                    <div class="justify-between px-2 border border-gray-200 rounded-xl shadow-sm">
                        ...
                        <div class="flex mb-1 px-2">
                          <label class="text-color block text-sm w-3/12 pr-2 pt-1"><?=checklang('RECMONEYCD')?></label>
                        ...
                        <div class="flex mb-1 px-2">
                          <label class="text-color block text-sm w-3/12 pr-2 pt-1"><?=checklang('RECEIVABLECD')?></label>
                          <div class="relative w-3/12 mr-2">
                              <input type="text" class="text-control text-sm shadow-md border z-20 rounded-xl h-7 w-full py-2 px-3 text-gray-700 border-gray-300 req"
...
<script type="text/javascript">
  ...
  function HandlePopupIndex(result, index) {
      $('#loading').show();
      return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/905/ACC_WHTMETHOD3/index.php?ACC_CD=' + result +'&index=' + index;
  }
