...
$javaload = getSystemData($_SESSION['APPCODE'].'_LOAD');
if(empty($javaload)) {
    $javaload = $javaFunc->load();
    setSystemData($_SESSION['APPCODE'].'_LOAD', $javaload);   
} 
$data['YEAR'] = $javaload['YEAR'];
...
// --------------------------------------------------------------------------//
function update() {
    $javaUpd = new YearEndProcess;
    $param = array("YEAR" => $_POST['YEAR']);                                                                     
...
function setSessionArray($arr){
    $keepField = array( 'TXTLANG', 'DRPLANG', 'YEAR');               
    foreach($arr as $k => $v){
