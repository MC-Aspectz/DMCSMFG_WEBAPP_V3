...
class SupplierHoldWithTax  extends Syslogic {

    public function __construct() {
        $this->APPCODE = 'ACC_WHTMETHOD2';
    }
   
    public function getSup($SUPPLIERCD) {
        $Param = array('SUPPLIERCD' => $SUPPLIERCD);
        // ,'DEBITACCCD2' => $DEBITACCCD2,'CREDITACCCD2' => $CREDITACCCD2);
        return $this->GetReques($Param, $this->APPCODE, 'get_sup');
    }

    public function search($SUPPLIERCD) {
        $Param = array('SUPPLIERCD' => $SUPPLIERCD);
        // ,'DEBITACCCD2' => $DEBITACCCD2,'CREDITACCCD2' => $CREDITACCCD2);
