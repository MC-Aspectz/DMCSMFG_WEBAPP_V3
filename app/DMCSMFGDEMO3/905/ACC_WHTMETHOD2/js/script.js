...
SEARCHSUPPLIER.click(function (e) {
  ...
  winopened = window.open(
    $("#sessionUrl").val() +
      "/guide/" +
      $("#comcd").val() +
      "/SEARCHSUPPLIER/index.php?page=ACC_WHTMETHOD2",
    "authWindow",
...
SEARCHACCOUNT1.click(function (e) {
  ...
  winopened = window.open(
    $("#sessionUrl").val() +
      "/guide/" +
      $("#comcd").val() +
      "/SEARCHACCOUNT/index.php?page=ACC_WHTMETHOD2&index=1",
    "authWindow",
    "width=1200,height=600"
  );
});
SEARCHACCOUNT2.click(function (e) {
  ...
  winopened = window.open(
    $("#sessionUrl").val() +
      "/guide/" +
      $("#comcd").val() +
      "/SEARCHACCOUNT/index.php?page=ACC_WHTMETHOD2&index=2",
    "authWindow",
    "width=1200,height=600"
  );
});
SEARCHACCOUNT3.click(function (e) {
  ...
  winopened = window.open(
    $("#sessionUrl").val() +
      "/guide/" +
      $("#comcd").val() +
      "/SEARCHACCOUNT/index.php?page=ACC_WHTMETHOD2&index=3",
    "authWindow",
    "width=1200,height=600"
  );
});
...
async function commit(method) {
  ...
  await axios
    .post("../ACC_WHTMETHOD2/function/index_x.php", data)
    .then((response) => {
